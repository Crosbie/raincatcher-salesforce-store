 ...
 * @constructor
 */
function SalesForceStore(datasetId, sheetId, entitySchema) {
 ...
 * @returns {Object}
 */
SalesForceStore.prototype.convertRowEntityToJSON = function convertRowEntityToJSON(rowEntity) {
 ...
 * @returns {Promise}
 */
SalesForceStore.prototype.getSheet = function getSheet() {
